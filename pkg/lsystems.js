...
* @param {string} color2
*/
export function generateCanvas(fractal_type, iterations, color1, color2) {
    ...
    wasm.generateCanvas(fractal_type, iterations, ptr0, len0, ptr1, len1);
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('lsystems_bg.wasm', import.meta.url);
    }
    const imports = getImports();
